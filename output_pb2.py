...
_REQUEST = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="keepalive",
            full_name="falco.output.request.keepalive",
            index=0,
            number=1,
            type=8,
            cpp_type=7,
...
_RESPONSE_OUTPUTFIELDSENTRY = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="key",
            full_name="falco.output.response.OutputFieldsEntry.key",
            index=0,
            number=1,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="value",
            full_name="falco.output.response.OutputFieldsEntry.value",
            index=1,
            number=2,
            type=9,
            cpp_type=9,
...
_RESPONSE = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="time",
            full_name="falco.output.response.time",
            index=0,
            number=1,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="priority",
            full_name="falco.output.response.priority",
            index=1,
            number=2,
            type=14,
            cpp_type=8,
        ...
        _descriptor.FieldDescriptor(
            name="source",
            full_name="falco.output.response.source",
            index=2,
            number=3,
            type=14,
            cpp_type=8,
        ...
        _descriptor.FieldDescriptor(
            name="rule",
            full_name="falco.output.response.rule",
            index=3,
            number=4,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="output",
            full_name="falco.output.response.output",
            index=4,
            number=5,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="output_fields",
            full_name="falco.output.response.output_fields",
            index=5,
            number=6,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="hostname",
            full_name="falco.output.response.hostname",
            index=6,
            number=7,
            type=9,
            cpp_type=9,
...
response = _reflection.GeneratedProtocolMessageType(
    ...
    (_message.Message,),
    {
        "OutputFieldsEntry": _reflection.GeneratedProtocolMessageType(
            "OutputFieldsEntry",
            (_message.Message,),
            {
