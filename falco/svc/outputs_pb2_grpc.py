...
class service(object):
    ...
    def sub(request_iterator,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.stream_stream(request_iterator, target, '/falco.outputs.service/sub',
            outputs__pb2.request.SerializeToString,
            outputs__pb2.response.FromString,
